---
description: Todos os atalhos do VS Code!
---

# All VS Code shortcuts pt-BR

![](https://i.imgur.com/8WMPSGN.png)
...
* PgUp / PgDn -Ctrl + Sugestão de acionamento de espaço
...
* Ctrl + Mostrar terminal integrado Ctrl + Shift + Criar novo terminal
